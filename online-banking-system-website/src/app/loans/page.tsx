          ...
          <div className="card">
            <div className="row">
              <div className="col ms-4 mt-3">
                <div className="card-title d-flex justify-content-center text-bold fs-4">Client Loans</div>
              </div>
            </div>
                ...
                <div className="col">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <hr></hr> <h5>Loan Approval Date : </h5> <p>12/08/2022</p>
                ...
                <div className="col">
                  <div className="card">
                    <div className="card-body">
                      <div className="card-title">Loan Info</div>
                      <h5>Loan Status : </h5>{" "}
                      <span className="badge text-bg-success">Fully Paid</span>
                      <hr></hr> <h5>Loan Approval Date : </h5> <p>24/09/2019</p>
                ...
                <div className="col">
                  <div className="card">
                    <div className="card-body">
                      ...
                      <h5>Loan Status : </h5>{" "}
                      <span className="badge text-bg-info">Active</span>
                      <hr></hr> <h5>Loan Approval Date : </h5> <p>01/01/2023</p>
