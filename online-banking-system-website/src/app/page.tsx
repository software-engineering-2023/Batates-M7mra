          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex flex-column gap-2">
                ...
                <hr />
                <Link className="btn btn-primary btn-lg" href="/bank-accounts">
                  View All Accounts
                </Link>
              </div>
            </div>
            ...
            <div className="card-footer">
              <div className="row g-2">
                <div className="col-lg-6">
                  <Link className="btn btn-primary w-100" href="/credit-cards">
                    View All Cards
                  </Link>
                </div>
          ...
          <div className="card">
            ...
            >
              ...
              <li className="list-group-item  d-flex gap-3 align-items-center">
                ...
                <div className="d-flex justify-content-evenly flex-column text-left ms-auto align-items-end">
                  <small className="text-body-secondary"> Due in 6 days</small>
                  <div>
                    <Link className="btn btn-primary" href="payment-form">
                      Pay
                    </Link>
